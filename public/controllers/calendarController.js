...
export class CalendarPageController extends BaseController {
  ...
  constructor() {
    ...
    this.events.push(
        ...
        {event: EVENTS.calendarPage.render.films, handler: this.view.renderCalendarFilms},
        {event: EVENTS.calendarPage.render.notFoundPremiers, handler: this.view.renderNotFound},
    );
  }
}
