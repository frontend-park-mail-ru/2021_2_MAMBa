;(function(root,factory){
    ...
    var puglatizer = {}
    puglatizer["auth"] = {}
    puglatizer["auth"]["auth"] = function template(t){var a,e,u="";try{var r=t||{};(function(t,a){e=1,u=u+"<div"+pug.attr("id",t?"auth":"reg",!0,!1)+">",e=2,u+='<div id="auth-head">',e=2,u+="Регистрация</div>",e=3,u+='<form id="auth-form">',e=4,function(){var t=a;if("number"==typeof t.length)for(var r=0,i=t.length;i>r;r++){var n=t[r];e=5,u=u+"<input"+(' class="text-inputs"'+pug.attr("type",n.type,!0,!1)+pug.attr("name",n.name,!0,!1)+pug.attr("placeholder",n.placeholder,!0,!1))+"/>"}else{var i=0;for(var r in t){i++;var n=t[r];e=5,u=u+"<input"+(' class="text-inputs"'+pug.attr("type",n.type,!0,!1)+pug.attr("name",n.name,!0,!1)+pug.attr("placeholder",n.placeholder,!0,!1))+"/>"}}}.call(this),e=11,u=u+'<input id="auth-btn" type="button"'+pug.attr("value",t?"Войти":"Создать аккаунт",!0,!1)+"/></form>",e=12,t?(e=13,u+='<a id="auth-a" href="">',e=13,u+="Еще нет аккаунта?</a>"):(e=15,u+='<a id="auth-a" href="">',e=15,u+="Уже есть аккаунт?</a>"),u+="</div>"}).call(this,"auth"in r?r.auth:"undefined"!=typeof auth?auth:void 0,"inputs"in r?r.inputs:"undefined"!=typeof inputs?inputs:void 0)}catch(i){pug.rethrow(i,a,e)}return u};
