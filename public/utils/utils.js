...
function deleteAllErrors(parentNode) {
    let errorBlocks = parentNode.querySelectorAll('.error-text');
...
function foundErrorFields(form) {
    let flag = false;
    let formTextInputs = form.querySelectorAll('.text-inputs');
...
function addFocusOutListeners(authForm) {
    let formTextInputs = authForm.querySelectorAll('.text-inputs');
    for (let input of formTextInputs) {
...
export {createElementFromHTML, includeStyle, createError, foundErrorFields, deleteAllErrors, addFocusOutListeners};
